...
function auth(req, res, next) {
  if (!req.signedCookies.user) {
    ...
    if (user === "admin" && pass === "password") {
      res.cookie("user", "admin", { signed: true }); //{signed: true} --> let's express know to use the secret key from cookie-parser 'cookieParser("12345-67890-09876-54321")' to sign cookie
